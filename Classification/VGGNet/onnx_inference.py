...
if __name__ == '__main__':
    ...
    VggNet = ONNXModel(onnx_model_path)
    out = VggNet.forward([to_numpy(img)])
    for i in range(len(VggNet.output_name)):
        print('==============================')
        print(out[VggNet.output_name[i]])
