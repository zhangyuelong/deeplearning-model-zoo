...
def main():
    ...
    # create model
    model = create_vgg(model_name='vgg16', num_classes=5, init_weights=False).to(device)
    # load model weights
    model_weight_path = 'weights/vgg16net.pth'
    ...
    traced_script_module.save("vgg16net.pt")
    print('---------------------------------')
    with torch.no_grad():
        # predict class
        import time
