...
class InvertedResidual(nn.Module):
    ...
    def forward(self, x):
        # print('self.input_padding is: ', self.input_padding)
        # print('================ x shape is: ', x.shape)
        x_pad = F.pad(x, self.input_padding)
        # print('================ x_pad is: ', x_pad.shape)
...
def create_mobilenetv2(pretrained=True, progress=True, **kwargs):
    """
...
if __name__ == '__main__':
    model = create_mobilenetv2(pretrained=True)
    print(model)
    model.eval()
