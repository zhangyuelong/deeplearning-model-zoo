...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default="weights/DeepLabV3plus_mobilenet_weights.pth", help="训练好的权重路径")
    ...
    model = deeplabv3plus_mobilenet(num_classes=2, output_stride=8, pretrained_backbone=False).to(device)
    ...
    traced_script_module.save("deeplabv3+_mobilenet.pt")
    print('---------------------------------')
