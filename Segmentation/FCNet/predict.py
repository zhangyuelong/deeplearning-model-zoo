...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default="weights/FCNet_weights.pth", help="训练好的权重路径")
    ...
    model = FCN(num_classes=2, backbone='vgg16_bn', pretrained=False).to(device)
    ...
    traced_script_module.save("fcnet.pt")
    print('---------------------------------')
