...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default="weights/SegNet_weights.pth", help="训练好的权重路径")
    ...
    model = SegNet(3, CLASS_NUM).to(device=device)
    ...
    traced_script_module.save("segnet.pt")
    print('---------------------------------')
