...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default="weights/UNet_weights.pth", help="训练好的权重路径")
    ...
    model = UNet(num_classes=CLASS_NUM, in_channels=3, pretrained=False).to(device=device)
